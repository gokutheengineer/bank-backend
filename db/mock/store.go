...
// Source: github.com/gokutheengineer/bank-backend/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetMaxBalanceForCurrency(arg0 context.Context, arg1 string) (interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMaxBalanceForCurrency", arg0, arg1)
...
func (mr *MockStoreMockRecorder) GetMaxBalanceForCurrency(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMaxBalanceForCurrency", reflect.TypeOf((*MockStore)(nil).GetMaxBalanceForCurrency), arg0, arg1)
}
...
func (m *MockStore) GetMinBalanceForCurrency(arg0 context.Context, arg1 string) (interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMinBalanceForCurrency", arg0, arg1)
	ret0, _ := ret[0].(interface{})
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetMinBalanceForCurrency(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMinBalanceForCurrency", reflect.TypeOf((*MockStore)(nil).GetMinBalanceForCurrency), arg0, arg1)
}
...
func (m *MockStore) ListTransfersAmong(arg0 context.Context, arg1 db.ListTransfersAmongParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransfersAmong", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) ListTransfersAmong(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransfersAmong", reflect.TypeOf((*MockStore)(nil).ListTransfersAmong), arg0, arg1)
}
...
func (m *MockStore) ListTransfersOf(arg0 context.Context, arg1 db.ListTransfersOfParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransfersOf", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) ListTransfersOf(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransfersOf", reflect.TypeOf((*MockStore)(nil).ListTransfersOf), arg0, arg1)
}
